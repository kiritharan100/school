                ...
                <div class="card">
                    <div class="card-header">
                        <form class="form-inline" method="GET" style="gap:10px;">
                            ...
                            <button type="button" class="btn btn-secondary ml-2" id="printReportBtn" onclick="printRevenueReport()">Print</button>
                        </form>
                    </div>
...
function printRevenueReport() {
    ...
    var url = 'report_revinue_expenditure_print.php?year=' + encodeURIComponent(year) + '&income_account=' + encodeURIComponent(income);

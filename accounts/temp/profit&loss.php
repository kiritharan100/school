    ...
    <h5> Trading and Profit and Loss Account for the  Period <?php echo $from_date." - ".$to_date;?></h5>
        ...
        <div class="pl-wrapper">
          <table class="pl-left">
            ...
            <tr><td><?= $tank_leakage_loss > 0 ? 'Add: Shortage of inventory' : 'Less: Shortage of inventory' ?></td><td class="text-right"><?= $tank_leakage_loss >= 0 ? formatAmt($tank_leakage_loss) : '(' . formatAmt(abs($tank_leakage_loss)) . ')' ?></td><td></td></tr>

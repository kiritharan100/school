...
$que = "SELECT SUM(sales_vat) as total_sales_vat from shed_operator_shift where   day_end = '$serial_no' AND location_id ='$location_id'";
$resx = mysqli_query($con, $que);
$vat = mysqli_fetch_assoc($resx);
$sales_vat = $vat['total_sales_vat'];
...
foreach ($entries as $entry) {
    ...
    $vat_rate = 0;
    $debit_vat = 0;
    $credit_vat = ($ca_id == 7) ? $sales_vat : 0;

        ...
        <aside class="main-sidebar hidden-print ">
            <section class="sidebar" id="sidebar-scroll">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="<?php $url='setting.php'; if($url == $current_url){echo "active";}?> treeview"> <a
                            class="waves-effect waves-dark" href="<?php echo $url; ?>"><i class="fa fa-cog"></i> <span>
                                System Settings</span></a></li>
                    </li>
                    ...
                    <li class="<?php $url='client_list.php'; if($url == $current_url){echo "active";}?> treeview"> <a
                            class="waves-effect waves-dark" href="<?php echo $url; ?>"> <i class="fa-solid fa-house-fire"></i><span>
                                Manage Clients</span></a></li>   

                                   <li class="<?php $url='manage_user.php'; if($url == $current_url){echo "active";}?> treeview"> <a
                            class="waves-effect waves-dark" href="<?php echo $url; ?>"> <i class="fa-solid fa-users"></i><span>
                                Manage Users</span></a></li>  
                </ul>
            </section>
        </aside>
        <!-- Sidebar chat start -->

                                ...
                                <table width='100%'>
                                    <thead>
                                        <tr bgcolor='#9CD0F8'>
                                            ...
                                            <th style='text-align:center;'> Centers</th>
                                    ...
                                    <tbody>
                                        ...
                                        $count = 1;
                                          $sel_query = "SELECT cr.c_id,cr.client_name,cr.client_type,ul.usr_id as picked FROM client_registration cr
                                          LEFT JOIN user_location ul on ul.location_id =cr.c_id AND ul.usr_id=$id 
                                          WHERE cr.subscription ='$subscription'
                                          ORDER BY cr.client_type,cr.client_name";
